...
import { getUserById, mockPosts } from '../data/mockData';
      ...
      <div className="max-w-5xl mx-auto px-4 py-8">
        ...
        <div className="bg-white rounded-2xl border border-gray-200 p-8 -mt-20 relative shadow-sm">
          <div className="flex flex-col md:flex-row md:items-start gap-6">
            {/* Avatar */}
            <Avatar className="w-32 h-32 ring-4 ring-white -mt-16">
            ...
            <div className="flex-1">
              ...
              <div className="flex gap-6">
                ...
                <div>
                  <span className="text-gray-900 mr-1">{user.followers}</span>
                  <span className="text-gray-600">Followers</span>
                </div>
                <div>
                  <span className="text-gray-900 mr-1">{user.following}</span>
